...
Для таго, каб стварыць праект, неабходна выбраць у меню катэгорыю праекта — _субтытры_ альбо _лакалізацыя_ — і на староны спісу праектаў націснуць на кнопку "Стварыць". **На цяперашні момант карыстальнік абмежаваны трыма праектамі для кожнай катэгорыі.** Калі карыстальнік ужо стварыў столькі праектаў, кнопка зробіцца неактыўнай.
